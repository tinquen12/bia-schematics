...
import { <%= classify(pluralName) %>IndexComponent } from '<%= indexViewRelativePath %>';
...
const ROUTES: Routes = [
  {
    ...
    data: {
      ...
      InjectComponent: <%= classify(pluralName) %>IndexComponent
    },
...
@NgModule({
  declarations: [
    ...
    <%= classify(pluralName) %>IndexComponent,
