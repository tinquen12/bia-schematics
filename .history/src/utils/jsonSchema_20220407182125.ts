...
function getResponseProperties(
  ...
  const arraySchema = (response as OpenAPIV3_1.ArraySchemaObject).items as OpenAPIV3_1.SchemaObject
  console.log(arraySchema.items as OpenAPIV3_1.SchemaObject))
}
